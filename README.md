...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client4/core_2.12/3.8.11)
...
```scala
import $ivy.`com.softwaremill.sttp.client4::core:3.8.11`
...
```scala
"com.softwaremill.sttp.client4" %% "core" % "3.8.11"
```
