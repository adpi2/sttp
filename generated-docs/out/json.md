...
```
"com.softwaremill.sttp.client4" %% "spray-json" % "3.8.11"
```
...
```scala
"com.softwaremill.sttp.client4" %% "play-json" % "3.8.11"
```
...
```scala
"com.softwaremill.sttp.client4" %% "zio-json" % "3.8.11"  // for ZIO 2.x
"com.softwaremill.sttp.client4" %% "zio1-json" % "3.8.11" // for ZIO 1.x
```
...
```scala
"com.softwaremill.sttp.client4" %% "jsoniter" % "3.8.11"
```
...
```scala
"com.softwaremill.sttp.client4" %% "upickle" % "3.8.11"
```
