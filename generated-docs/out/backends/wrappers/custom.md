...
```
"com.softwaremill.sttp.client4" %% "core" % "3.8.11" % Test classifier "tests"
```
...
```scala
"com.softwaremill.sttp.client4" %% "cats" % "3.8.11" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client4" %% "catsce2" % "3.8.11" // for cats-effect 2.x
```
