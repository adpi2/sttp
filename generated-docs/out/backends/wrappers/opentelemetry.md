...
```
"com.softwaremill.sttp.client4" %% "opentelemetry-metrics-backend" % "3.8.11"
```
...
```
"com.softwaremill.sttp.client4" %% "opentelemetry-tracing-zio-backend" % "3.8.11"  // for ZIO 2.x
"com.softwaremill.sttp.client4" %% "opentelemetry-tracing-zio1-backend" % "3.8.11" // for ZIO 1.x
```
