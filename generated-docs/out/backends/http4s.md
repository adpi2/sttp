...
```scala
"com.softwaremill.sttp.client4" %% "http4s-backend" % "3.8.11" // for cats-effect 3.x & http4s 1.0.0-Mx
// or
"com.softwaremill.sttp.client4" %% "http4s-ce2-backend" % "3.8.11" // for cats-effect 2.x & http4s 0.21.x
```
