...
```scala
"com.softwaremill.sttp.client4" %% "fs2" % "3.8.11" // for cats-effect 3.x & fs2 3.x
// or 
"com.softwaremill.sttp.client4" %% "fs2-ce2" % "3.8.11" // for cats-effect 2.x & fs2 2.x
```
...
```scala
"com.softwaremill.sttp.client4" %% "armeria-backend-fs2" % "3.8.11" // for cats-effect 3.x & fs2 3.x
// or
"com.softwaremill.sttp.client4" %% "armeria-backend-fs2" % "3.8.11" // for cats-effect 2.x & fs2 2.x
```
