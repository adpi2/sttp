...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "core" % "3.8.11")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "akka-http-backend" % "3.8.11",
  "com.softwaremill.sttp.client4" %% "json4s" % "3.8.11",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "zio" % "3.8.11",
  "com.softwaremill.sttp.client4" %% "circe" % "3.8.11",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "monix" % "3.8.11",
  "com.softwaremill.sttp.client4" %% "circe" % "3.8.11",
  "io.circe" %% "circe-generic" % "0.14.1"
)
```
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "slf4j-backend" % "3.8.11",
  "com.softwaremill.sttp.client4" %% "circe" % "3.8.11",
  "io.circe" %% "circe-generic" % "0.14.1"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "zio" % "3.8.11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "fs2" % "3.8.11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "monix" % "3.8.11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "akka-http-backend" % "3.8.11")
```
